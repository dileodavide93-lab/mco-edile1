...
export const QuoteModal: React.FC<QuoteModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={handleClose}>
      ...
      <div
        className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-8 md:p-10"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full hover:bg-zinc-100 transition-colors text-zinc-400 hover:text-zinc-700 text-2xl"
        >
          &times;
        </button>
        ...
        {submitted ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-3xl font-bold mb-4">Richiesta inviata!</h3>
            <p className="text-zinc-500 text-lg mb-8">Ti ricontatteremo entro 24 ore per fissare un sopralluogo gratuito.</p>
          ...
          <>
            <h3 className="text-3xl font-bold mb-2">Richiedi Preventivo</h3>
            <p className="text-zinc-500 mb-8">Compila il modulo e ti ricontatteremo entro 24 ore.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  name="nome"
                  required
                  className="w-full px-4 py-3 border-2 border-zinc-200 rounded-xl focus:border-red-600 focus:outline-none transition-colors"
              ...
              <div>
                ...
                <select
                  name="tipo_lavoro"
                  className="w-full px-4 py-3 border-2 border-zinc-200 rounded-xl focus:border-red-600 focus:outline-none transition-colors bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  name="messaggio"
                  rows={3}
                  className="w-full px-4 py-3 border-2 border-zinc-200 rounded-xl focus:border-red-600 focus:outline-none transition-colors resize-none"
